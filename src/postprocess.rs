//! Post-processing via shaders.
//!
//! Code based on <https://github.com/bevyengine/bevy/blob/5c759a1be800209f537bea31d32b8ba7e966b0c1/examples/shader/post_processing.rs>.
...
const SHADER_ASSET_PATH: &str = "shaders/dithering.wgsl";
